<?php 
 ...
 // echo $invoice_id;
    ...
    $userqueryinvoice = "SELECT * FROM applepen.invoice join purchase_order using(po_id)where invoice_id ='$invoice_id'";
    ...
    while ($pr = mysqli_fetch_assoc($querypr)){
        ...
        <div class="col-xs-12">
    		...
    		<div class="row">
				...
				<div class="col-xs-8 text-right">
                    ...
                    <strong>P.O. #</strong><?php echo " ".$po_id;?><br>
    			</div>
    		</div>
    		<div class="row">
                <div class="col-xs-4">
