...
$queryinvoice = "SELECT * FROM applepen.invoice join applepen.purchase_order using (po_id)";
$invoice = mysqli_query($connect,$queryinvoice);
				...
				<div class="col-sm-12 col-md-5 h-100 h-sm-50">
					<div class="dplay-tbl">
						<div class="dplay-tbl-cell color-white mtb-30">
							<div class="mx-w-500x">
								<h1 class="mt-20 mb-30"><b>INVOICE LIST</b></h1>
							</div><!-- mx-w-200x -->
						</div><!-- dplay-tbl-cell -->
					</div><!-- dplay-tbl -->
				</div><!-- col-sm-6 -->
    			...
    			<div class="panel-body">
    				<div class="table-responsive">
    					<table class="table table-condensed">
    						<thead>
                                <tr>
        							<td class="text-left"><strong>INVOICE ID</strong></td>
        							<td class="text-center"><strong>PURCHASE ORDER ID</strong></td>
                                    <td class="text-right"><strong> INVOICE TOTAL</strong></td>
                                </tr>
							</thead>
							<tbody>
							<?php while ($detail = mysqli_fetch_assoc($invoice)){  
                            echo"<tr>
                                    <td class=\"text-left\"><a href=\"display_invoice_from_list.php?invoice_id=".$detail['invoice_id']."\">".$detail['invoice_id']."</td>
    								<td class=\"text-center\"><a href=\"display_po_from_list.php?po_id=".$detail['po_id']."\">".$detail['po_id']."</td>
                                    <td class=\"text-right\">".$detail['invoice_total']."</td>
                                </tr>";
                            } ?>
							</tbody>
    					</table>
