...
$querypo = "SELECT * FROM applepen.purchase_requisition join applepen.purchase_order using (pr_id)";
$purchase = mysqli_query($connect,$querypo);
				...
				<div class="col-sm-12 col-md-5 h-100 h-sm-50">
					<div class="dplay-tbl">
						<div class="dplay-tbl-cell color-white mtb-30">
							<div class="mx-w-500x">
								<h1 class="mt-20 mb-30"><b>PURCHASE ORDER LIST </b></h1>
							</div><!-- mx-w-200x -->
						</div><!-- dplay-tbl-cell -->
					</div><!-- dplay-tbl -->
				</div><!-- col-sm-6 -->
    			...
    			<div class="panel-body">
    				<div class="table-responsive">
    					<table class="table table-condensed">
    						<thead>
                                <tr>
        							<td class="text-left"><strong>PO ID</strong></td>
        							<td class="text-center"><strong>PR ID</strong></td>
                            ...
                            echo"<tr>
                                    <td class=\"text-left\"><a href=\"display_po_from_list.php?po_id=".$detail['po_id']."\">".$detail['po_id']."</td>
    								<td class=\"text-center\"><a href=\"display_pr_from_list.php?pr_id=".$detail['pr_id']."\">".$detail['pr_id']."</td>
    								<td class=\"text-center\">".$detail['po_date']."</td>
                                    <td class=\"text-right\">".$detail['po_total']."</td>
                                </tr>";
