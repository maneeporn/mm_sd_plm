<?php 
    ...
    while ($data = mysqli_fetch_assoc($purchase_id)){
		$pr_id = $data['pr_id'];
	...
	$userquerydetail = "SELECT * from applepen.material join applepen.inventory using (material_id) join purchase_requisition_detail using (inventory_id) where pr_id ='$pr_id' ";
        ...
        <div class="col-xs-12">
    		...
    		<div class="row">
				...
				<div class="col-xs-6 text-right">
					...
					<strong>Ship Via:</strong><?php echo " ".$shipvia;?><br>
    			</div>
    		</div>
    		<div class="row">
    			<div class="col-xs-4">
...
<b><a href='create_po.php' style='font-size: 0.8em; text-align: center;  display:block;'><h2>CREATE PURCHASE ORDERS</h2></a></b><br>