...
//echo "<form class='form-block form-h-55 form-plr-20 form-bg-white text-center' action='show_gr.php' method='GET'>";
$userQuery = "SELECT * from document_sd join doc_sd_type using(doc_sd_type_id) join customer using (customer_id) 
join company using (company_id) join employee using (employee_id) where doc_sd_type_id = 4";
...
while ($row = mysqli_fetch_assoc($result))
{
    echo "<tr>  <td>".$row['doc_id']."</td>
				...
				<form action='show_gr.php' medthod='get'>
