...
$userquery4="SELECT * FROM document_sd where `doc_sd_type_id` = 1 ORDER BY doc_id DESC limit 1";
$result4=mysqli_query($connect,$userquery4);
$sale = mysqli_fetch_assoc($result4);
      ...
      <div class="container-fluid h-100 mt-xs-50">
        <div class="dplay-tbl">
          <div class="dplay-tbl-cell color-white text-center">
            ...
            <h1 class="ptb-50"><b>GOODS ISSUE</b></h1>
...
<!-- form -->
    ...
    <div class="container">
    <form action="add-goodsissue.php" medthod="GET">

      <div class="row">
      <div class="col-25">
      <label for="company_id">Sale Order docment ID</label>
      </div>
      <div class="col-75">
      		<p><?php
      		 echo $sale['doc_id'];
      		 echo "<input name=\"doc_id\" value=\"{$sale['doc_id']}\" type=\"hidden\">";
      		?></p>
...
<div class="col-75">
    <p><?php
     ...
     //    echo "</tr>";
     //    echo "<td>".$company['company_tel']."</td>";
     //    echo "</tr>";
...
<div class="col-75">
     ...
     // print "<td>%s</td>",$customer['customer_ship_address'];
     // echo "</tr>";
      ?></p>
</div>
</div>
...
<div class="col-75">
  ...
  ?></p>
					...
					<div class="row">
					<div class="col-25">
						<label for="employee_id">Ship Detail</label>
					</div>
					<div class="col-75">
						<input type="text" name="ship_detail" placeholder="Ship Detail">
					</div>
					</div>
