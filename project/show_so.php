    ...
    <div class="row">
        <div class="col-xs-12">
    		<div class="invoice-title">
				<h2>Sale Order</h2><h3 class="pull-right">Sale Order ID # <?php echo $id ; ?></h3><br>
    		</div>
    		<hr>
            <div class="row">
    			<div class="col-xs-6 ">
    				...
    				<div class="table-responsive">
    					<table class="table table-condensed">
    						<thead>
                                <tr>
                                    ...
                                    <td class="text-center"><strong>Requested Delivery Date</strong></td>
						...
						while ($row = mysqli_fetch_assoc($result))
						{
							echo "<tr>
    								...
    								<td class='text-center'>".$row['request_delivery_date']."</td>
									<td class='text-center'>".$row['ship_detail']."</td>
